const { createMenuItem, updateMenuItem, deleteMenuItem, getChefSpecial, getMenuItems, updateChefSpecial } = require('../controllers/menuItemController')
...
menuItemRouter.get('/chefSpecial', authRole('customer','staff','admin'), getChefSpecial)
