...
const MenuItemPage = () => {
const menuItems = [
                    { id: 1, name: 'Classic Burger', price: 12.99, category: 'Main Course', image: '/api/placeholder/300/200', rating: 4.7, dietary: ['meat'] },
                    { id: 2, name: 'Caesar Salad', price: 8.99, category: 'Appetizers', image: '/api/placeholder/300/200', rating: 4.5, dietary: ['vegetarian'] },
                    { id: 3, name: 'Chocolate Cake', price: 6.99, category: 'Desserts', image: '/api/placeholder/300/200', rating: 4.9, dietary: ['vegetarian'] },
                    { id: 4, name: 'Veggie Pizza', price: 14.99, category: 'Main Course', image: '/api/placeholder/300/200', rating: 4.6, dietary: ['vegetarian'] },
                    { id: 5, name: 'Grilled Chicken', price: 15.99, category: 'Main Course', image: '/api/placeholder/300/200', rating: 4.8, dietary: ['meat'] },
                    { id: 6, name: 'Fruit Smoothie', price: 5.99, category: 'Drinks', image: '/api/placeholder/300/200', rating: 4.4, dietary: ['vegan', 'gluten-free'] },
                ];
  return (
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2 md:gap-4">
              ...
              <button className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition duration-300">
                Reset
              </button>
            </div>
          </div>
